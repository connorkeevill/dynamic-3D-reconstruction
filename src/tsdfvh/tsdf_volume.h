 ...
 */
		...
		public:
			...
			Voxel GetVoxel(float3 position);
			...
			Voxel GetInterpolatedVoxel(float3 position);
			...
			bool SetVoxel(float3 position, const Voxel &voxel);
			...
			bool UpdateVoxel(float3 position, const Voxel &voxel);
		...
		protected:
			...
			int3 WorldToGlobalVoxel(float3 position);
